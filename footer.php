...
<?php 
	...
	$weareopen = true; } else { $weareopen = false; }
?>
  ...
  <a href="http://premier-pharmacy.com/product-category/mans-health/">http://premier-pharmacy.com/product-category/mans-health/</a>
 </div>
</footer>
